...
class Content(models.Model):
    FOREIGN_LIMIT_CHOICES = ('text', 'video', 'image', 'file')
    
    module = models.ForeignKey(Module, on_delete=models.CASCADE, related_name='contents')
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, limit_choices_to={'model__in':FOREIGN_LIMIT_CHOICES})
